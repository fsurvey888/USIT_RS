    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <section className="bg-white border-b border-gray-200 py-4">
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex items-center gap-2 text-sm">
            ...
            <span className="text-green-800 font-semibold">Vijesti</span>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white py-12">
        <div className="max-w-6xl mx-auto px-6 text-center">
          <h1 className="text-4xl font-bold text-green-800 mb-3">Sve vijesti</h1>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex flex-col md:flex-row gap-6 md:items-center flex-wrap">
            <div className="flex flex-col md:flex-row md:items-center gap-3">
              <label className="text-sm font-semibold text-green-800">Filter po kategoriji:</label>
              <select
              ...
              >
                ...
                <option value="istrazivanje">Istraživanje</option>
                <option value="dogadjaji">Događaji</option>
                <option value="tehnologija">Tehnologija</option>
                <option value="zastita">Zaštita</option>
              </select>
            </div>

            <div className="flex flex-col md:flex-row md:items-center gap-3">
              <label className="text-sm font-semibold text-green-800">Sortiraj po:</label>
              <select
                value={sortBy}
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-4 mb-4 text-sm text-gray-600">
                      <div className="flex items-center gap-1">
                        ...
                        <span>{item.comments} komentara</span>
                      </div>
                      <div className="flex items-center gap-1">
