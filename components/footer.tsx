    ...
    <footer className="bg-emerald-50 border-t border-gray-200 py-16">
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-8">
          ...
          <div>
            <h3 className="text-lg font-bold text-emerald-700 mb-3">
              Udruženje šumarskih inženjera i tehničara Republike Srpske
            </h3>
            <p className="text-gray-600 text-sm leading-relaxed">
              Profesionalna organizacija posvećena razvoju šumarstva i zaštiti šumskih resursa.
            </p>
          </div>

          {/* Quick Links */}
          <div>
            <h4 className="font-bold text-emerald-700 mb-4">Brzi linkovi</h4>
          ...
          <div>
            <h4 className="font-bold text-emerald-700 mb-4">Kontakt</h4>
            <ul className="space-y-3 text-sm">
              <li className="flex items-center gap-3">
                <Mail className="w-4 h-4 text-emerald-700 flex-shrink-0" />
                <a
                  href="mailto:usitrs@teol.net"
                  className="text-gray-600 hover:text-emerald-700 transition-colors"
                >
                  usitrs@teol.net
                </a>
              ...
              <li className="flex items-center gap-3">
                ...
                <span className="text-gray-600">Romanijska 1, Sokolac</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-200 pt-8 text-center text-sm text-gray-600">
          <p>© 2025 Udruženje šumarskih inženjera i tehničara Republike Srpske. Sva prava zadržana.</p>
        </div>
      </div>
    </footer>
  );
